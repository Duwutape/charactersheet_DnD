...
public class Spells {
    ...
    public static final String[] ALL_SPELLS_LVL_1 = {ALARM, ANIMAL_FRIENDSHIP, ARMOR_OF_AGATHYS, ARMS_OF_HADAR,
            BANE, BLESS, BURNING_HANDS, CHARM_PERSON, CHROMATIC_ORB, COLOR_SPRAY, COMMAND, COMPELLED_DUEL,
            COMPREHEND_LANGUAGES, CREATE_OR_DESTROY_WATER, CURE_WOUNDS, DETECT_EVIL_AND_GOOD, DETECT_MAGIC,
            DETECT_POISON_AND_DISEASE, DISGUISE_SELF, DISSONANT_WHISPERS, DIVINE_FAVOR, ENSNARING_STRIKE, ENTANGLE,
            EXPEDITIOUS_RETREAT, FAERIE_FIRE, FALSE_LIFE, FEATHER_FALL, FIND_FAMILIAR, FOG_CLOUD, GOODBERRY, GREASE,
            GUIDING_BOLT, HAIL_OF_THRONES, HEALING_WORD, HELLISH_REBUKE, HEROISM, HEX, HUNTERS_MASK, IDENTIFY,
            ILLUSORY_SCRIPT, INFLICT_WOUNDS, JUMP, LONGSTRIDER, MAGE_ARMOR, MAGIC_MISSILE,
            PROTECTION_FROM_EVIL_AND_GOOD, PURIFY_FOOD_AND_DRINK, RAY_OF_SICKNESS, SANCTUARY, SEARING_SMITE, SHIELD,
            SHIELD_OF_FAITH, SILENT_IMAGE, SLEEP, SPEAK_WITH_ANIMALS, TASHAS_HIDEOUS_LAUGHTER, TENSERS_FLOATING_DISK,
            THUNDEROUS_SMITE, THUNDERWAVE, UNSEEN_SERVANT, WITCH_BOLT, WRATHFUL_SMITE};
